...
PRODUCT_COPY_FILES += device/xiaomi/nikel/sbk-kpd.kl:system/usr/keylayout/sbk-kpd.kl \
                      device/xiaomi/nikel/sbk-kpd.kcm:system/usr/keychars/sbk-kpd.kcm
endif

# Add FlashTool needed files
#PRODUCT_COPY_FILES += device/xiaomi/$(MTK_TARGET_PROJECT)/EBR1:EBR1
#ifneq ($(wildcard device/xiaomi/$(MTK_TARGET_PROJECT)/EBR2),)
#  PRODUCT_COPY_FILES += device/xiaomi/$(MTK_TARGET_PROJECT)/EBR2:EBR2
#endif
#PRODUCT_COPY_FILES += device/xiaomi/$(MTK_TARGET_PROJECT)/MBR:MBR
#PRODUCT_COPY_FILES += device/xiaomi/$(MTK_TARGET_PROJECT)/MT6797_Android_scatter.txt:MT6797_Android_scatter.txt
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/nikel/factory/res/sound/testpattern1.wav:system/res/sound/testpattern1.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/nikel/factory/res/sound/ringtone.wav:system/res/sound/ringtone.wav
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/nikel/factory/res/images/lcd_test_00.png:system/res/images/lcd_test_00.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/nikel/factory/res/images/lcd_test_01.png:system/res/images/lcd_test_01.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/nikel/factory/res/images/lcd_test_02.png:system/res/images/lcd_test_02.png
