...
$(call inherit-product, device/xiaomi/$(MTK_TARGET_PROJECT)/device.mk)
...
KERNEL_DEFCONFIG ?= nikel_defconfig
PREBUILT_KERNEL := $(DEVICE_PATH)/prebuilt/kernel
PREBUILT_DTB := $(DEVICE_PATH)/prebuilt/01_dtbdump_MT6797.dtb
KERNEL_SOURCE := kernel/xiaomi/nikel
PRELOADER_TARGET_PRODUCT ?= nikel
LK_PROJECT ?= nikel
TRUSTY_PROJECT ?= nikel
